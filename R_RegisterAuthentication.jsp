...
<%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("ctype"))
							{
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from enduser  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("End user Name Already Exits");							
							%>
							<style type="text/css">
<!--
...
-->
							...
							<p><a href="R_Login.jsp" class="style1">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					  PreparedStatement ps=connection.prepareStatement("insert into enduser(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,ctype) values(?,?,?,?,?,?,?,?,?,?,?,?)");
